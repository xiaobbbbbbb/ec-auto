	...
	<div data-role="page" id="home">
		...
		<div data-role="content">
			...
			<ul data-role="listview" data-inset="true" data-divider-theme="b">
				<li data-role="list-divider">相关文章(${page.total?c})</li>
				...
				<li>
					<div data-role="controlgroup" data-type="horizontal" id="pager" pageSize="${page.pageSize?c}" data-mini="true">
					    <a href="/industry_article/detail?articleId=${article.id?c}&page=${page.prePage}&userId=${userId?c}" data-role="button" data-icon="arrow-l" data-iconpos="left">上一页</a>
					    <a href="/industry_article/detail?articleId=${article.id?c}&page=${page.nextPage}&userId=${userId?c}" data-role="button" data-icon="arrow-r" data-iconpos="right">下一页</a>
