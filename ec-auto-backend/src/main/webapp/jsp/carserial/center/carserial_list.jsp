<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	<div id="pager_params" url="/carserial/list"></div>
	<table id="table" class="easyui-datagrid" style=""
			title="车系列表" iconCls="icon-save"
		...
		<thead>
			<tr>
				...
				<th field="brandName" width="200">厂牌</th>
				<th field="isValid" width="100">状态</th>
				<th field="isFollow" width="100">是否关注</th>
 	...
 	<div id="table_toolbar" style="padding:5px;height:auto">
		...
		<div>
	    	...
	    	车牌名:
	    	<input class="search-field" style="width:200px;" type="text" name="brandName"></input>
	    	状态:
	...
	<script type="text/javascript">
		...
		function doDiscard(id, discard) {
			AjaxUtils.ajaxPost("/carserial/discard", {"serialId":id, "discard":discard}, function(json) {
   				if (json.succ=='Y') {
   					top.document.location.href ="/carserial/index";
   				} else {
	...
	<jsp:include page="add_carserial.jsp"></jsp:include>
	<jsp:include page="edit_carserial.jsp"></jsp:include>
